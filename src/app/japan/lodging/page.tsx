...
export const metadata: Metadata = {
  title: "住 · 日本住宿精選 | 日本大小事備忘錄",
  description:
    "各地區代表級以上的溫泉旅館、度假村、商務連鎖、Glamping。點進地區頁看完整清單。",
  alternates: { canonical: "/japan/lodging" },
};
...
export default async function LodgingCategoryPage() {
      ...
      <div className="mx-auto max-w-4xl px-6 py-14">
        ...
        <header className="mt-6">
          ...
          <p className="mt-1 text-xs text-zinc-500">
            僅列「地區代表」與「全國級」。點進各地區可看當地完整 lodging 清單。
          </p>
        </header>
