...
// ISR — 1 時間に 1 回再生成(force-dynamic だと毎 request DB 全 fetch・egress 浪費)
export const revalidate = 3600;

export const metadata: Metadata = {
  title: "食 · 日本飲食精選 | 日本大小事備忘錄",
  description:
    "各地區代表級以上的美食、市場、特產。點進地區頁看完整清單。",
  alternates: { canonical: "/japan/food" },
};
      ...
      <div className="mx-auto max-w-4xl px-6 py-14">
        ...
        <header className="mt-6">
          ...
          <p className="mt-1 text-xs text-zinc-500">
            僅列「地區代表」與「全國級」。點進各地區可看當地完整 food 清單。
          </p>
        </header>
